...
| lockDuration | The time that the Locked screen is shown in miliseconds                                                                                                                                                                                            | false    | 60000 (one minute) |
...
| footerText | the text of the footer button           | false    | Forgot PIN?                  |
...
| cancel   | the cancel button                                 | false    | Cancel                                    |
...
| resetButton   | The reset button text             | false    | Reset                                                  |
| confirm       | Ask user to confirm removeing PIN | false    | Are you sure you want remove the PIN?                  |
| confirmButton | The confirm button text           | false    | Confirm                                                |
| backButton    | The back button text              | false    | Back                                                   |
...
| title          | TextStyle of the title                                                                    | false    |         |
| subTitle       | TextStyle of the sub title                                                                | false    |         |
| clockContainer | ViewStyle which wraps the clock                                                           | false    |         |
| clockText      | TextStyle of the count down                                                               | false    |         |
| locked         | TextStyle of the lockedText. If you use custom icon for this, you can set the icon style. | false    |         |
...
| title          | TextStyle of the title                                                       | false    |         |
| subTitle       | TextStyle of the sub title                                                   | false    |         |
| buttons        | TextStyle of the buttons in Reset screen, including Reset and Confirm butons | false    |         |
